...
export const metadata: Metadata = {
  ...
  description:
    "Professionele zorgbeveiliging in Limburg. De-escalatie getrainde beveiligers voor ziekenhuizen, verpleeghuizen, GGZ en AZC. Praesidion Security — vergunning ND 8969.",
