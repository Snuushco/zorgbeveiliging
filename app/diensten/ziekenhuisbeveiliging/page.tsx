...
export const metadata: Metadata = {
  ...
  description: "Gespecialiseerde ziekenhuisbeveiliging met de-escalatie getrainde beveiligers. SEH, psychiatrie, bezoekersstromen. Praesidion Security — vergunning ND 8969.",
};
